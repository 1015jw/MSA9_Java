...
- {
	...
	public static void main(String[] args) {
		List<User> userList = Arrays.asList(
			...
			new User("wqer1222", "김조은", 25),
			new User("yuhbas323", "최조은", 25),
			new User("ervhdsq22", "이조은", 25),
			new User("pirdgaf6", "박조은", 25),
			new User("knrvse768", "힘조은", 30),
			new User("omqwwx567", "양조은", 32),
			new User("ouydfbrt34", "질조은", 28)
		);
