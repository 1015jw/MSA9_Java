...
public class StringEx {
	...
	public static void main(String[] args) {
		...
		System.out.println( str1.contains("Academy") );			// 문자열 포함 여부
		System.out.println( str1.equals(str2) );				// 문자열 일치 여부
		System.out.println( str1.equalsIgnoreCase(str2) );		// 대소문자 구분 없이 일치 여부
		...
		System.out.println( str1.length() );					// 문자열 길이 (글자수)[공백포
		...
		System.out.println( str1.substring(10, 17) );			// index~(index2-1)까지 반환
																// index 10번째부터 16번째까지의 문자열을 가져온다.
																// Academy
																// [10]~[16]
		...
		// String.split( 정규표현식 )
		// : 정규표현식에서 + 기호는 산순연산자가 아닌 다른 의미로 사용
		// 	 산술연산자 +로 구분하려면 앞에 \\ 기호를 붙여주어야 한다.
		// String cal = "10+20";
