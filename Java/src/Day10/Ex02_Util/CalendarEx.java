...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		// 1970년 1월 1일 0시 0분 0초 0ms부터 현재 날짜/시간까지 카운트한 숫자를 반환
		// 0.001초 : 1ms
		// 60초 : 1분
		// 60분 : 1시간
		// 24시 : 1일
		...
		birth.set(1997, Calendar.OCTOBER, 15, 0, 0, 0);		// 내 생일로 날짜 지정하기
		long birthT = birth.getTimeInMillis();
		long birthD = birthT / (1000 * 60 * 60 * 24);
		System.out.println("생후 " + birthD + "일이 지났습니다.");
