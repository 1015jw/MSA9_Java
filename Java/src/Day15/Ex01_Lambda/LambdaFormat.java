...
/**
 * 람다식 사용하기 1. 함수형 인터페이스 정의 * @FuntionalInterFace 어노테이션을 지정 * 추상 메소드 1개만 정의 2.
 * 람다식 익명함수를 정의하여 인터페이스에 선언 3. 람다식 호출
 */
@FunctionalInterface // 컴파일러에 함수형 인터페이스임을 명시적으로 알려준다,
interface FuncInterface1 {
	// * @FuntionalInterface를 지정하면, 추상메소드가 없거나 2개 이상이면 에러 발생
	void method();
...
public class LambdaFormat {
	...
	public static void main(String[] args) {
		...
		// () -> System.out.println("람다식"); * 한 문장이면 {} 생략 가능
		...
		// (a, b) -> a + b				* return문만 있다면, "return {}" 동시에 생략 가능
